...
[![Plugin Version](https://img.shields.io/badge/version-1.0.3-blue.svg?style=flat-square)](https://plugins.jetbrains.com/plugin/28386-android-now-activity)
...
3. **生成的插件文件**
   ```
   build/distributions/AndroidNowActivity-1.0.3.zip
   ```
